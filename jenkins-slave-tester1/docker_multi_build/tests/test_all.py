...
class AllTests(unittest.TestCase):
    ...
    def test_cosmic_api1(self):
        ...
        response = requests.post('http://192.168.1.27/rpc/Command.PWM', headers={"Content-Type": "application/json"}, json={"cmd":208,"address": 65535, "params":[0,1,0]})
    ...
    def test_cossmsisc_api1(self):
        response_0 = requests.get('https://chercher.tech/sample/api/product/read?id=90')
        response_1 = requests.post('http://192.168.1.27/rpc/Command.PWM', headers={'Content-Type': 'application/json'}, json={"cmd":210,"address":65535,"params":[50]})
